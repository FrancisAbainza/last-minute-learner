...
import { Brain, Zap, FileText, Upload, ArrowRight, FileUp, Type, Sparkles, MapPin, Phone, Mail } from "lucide-react"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-primary/10 to-primary/20 rounded-3xl blur-3xl -z-10" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground text-pretty max-w-2xl mx-auto">
              Upload PDFs, Word documents, PowerPoint presentations, or describe any topic, and our AI instantly creates personalized study tools tailored to your
              learning style.
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
              ...
              <div className="relative">
                <Card className="border-2 border-dashed border-primary/30 hover:border-primary transition-colors">
                  <CardContent className="p-8 text-center space-y-4">
                    ...
                    <h3 className="text-xl font-semibold">Upload PDF, Word, or PowerPoint Files</h3>
                    <p className="text-foreground/80">
                      Drag and drop textbooks, lecture notes, research papers, or any document
                    </p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="border hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                <CardContent className="p-6 space-y-4 text-center">
                  <div className="w-16 h-16 bg-linear-to-br from-blue-500/20 to-blue-600/20 rounded-xl flex items-center justify-center mx-auto border border-blue-500/20">
              ...
              <Card className="border hover:border-green-500/50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                <CardContent className="p-6 space-y-4 text-center">
                  <div className="w-16 h-16 bg-linear-to-br from-green-500/20 to-green-600/20 rounded-xl flex items-center justify-center mx-auto border border-green-500/20">
                    <Zap className="h-8 w-8 text-green-600" />
                  </div>
                  <h3 className="text-xl font-semibold">Interactive Quizzes</h3>
                  <p className="text-muted-foreground text-sm">
                    Practice questions with multiple choice to test your understanding and reinforce learning.
                  </p>
              ...
              <Card className="border hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                <CardContent className="p-6 space-y-4 text-center">
                  <div className="w-16 h-16 bg-linear-to-br from-purple-500/20 to-purple-600/20 rounded-xl flex items-center justify-center mx-auto border border-purple-500/20">
            ...
            {/* Process Steps */}
            <div className="mt-16 border border-border rounded-2xl p-8 max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Drop your PDFs, Word docs, or PowerPoint files, or describe your topic in plain English
                      </p>
                    </div>
                  </div>

                  <div className="flex flex-col items-center text-center space-y-4">
                    <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center border border-accent/30">
